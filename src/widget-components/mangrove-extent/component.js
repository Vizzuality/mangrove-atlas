  ...
  try {
    ...
    sentence = (
      <>
        ...
        <span>was </span>
        <strong className="notranslate">{quantity} </strong>{unitSelector}<span> in </span>{yearSelector},<span> this represents a linear coverage of the <strong>{coveragePercentage}%</strong> </span> of the
