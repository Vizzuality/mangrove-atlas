...
export const LanguageSelector = () => {
  ...
  return (
    <div className="absolute top-0 right-20 w-44 print:hidden">
      <Select onValueChange={(value) => onChangeLanguage(value)}>
        <SelectTrigger className="pointer-events-auto flex h-3 rounded-b-[20px] bg-brand-800 py-1 px-5 font-sans text-xs font-semibold uppercase text-white">
