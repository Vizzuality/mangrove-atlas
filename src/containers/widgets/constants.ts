...
const widgets_dev = [
  {
    ...
    categoryIds: ['custom', 'distribution_and_change'],
    layersIds: [''],
  },
  {
    ...
    categoryIds: ['custom', 'restoration_and_conservation'],
...
const widgets_prod = [
  ...
  },
  {
    ...
    categoryIds: ['custom', 'distribution_and_change', 'restoration_and_conservation'],
    layersIds: ['extent'],
  },
  {
  ...
  },
  {
    ...
    locationType: ['custom-area', 'wdpa', 'country', 'worldwide'],
    applicability: 'Global, National, Sub-National, and Local',
    categoryIds: ['custom', 'restoration_and_conservation', 'distribution_and_change'],
  ...
  },
  {
    ...
    locationType: ['custom-area', 'wdpa', 'country', 'worldwide'],
    applicability: 'Global, National, and Sub-National',
    categoryIds: ['custom', 'ecosystem_services'],
    layersIds: ['biomass'],
  },
  {
  ...
  },
  {
    ...
    applicability: 'Global, National, and Sub-National',
    categoryIds: ['custom', 'climate_and_policy', 'ecosystem_services'],
    layersIds: ['carbon'],
  },
  {
    ...
    applicability: 'Global and National',
    categoryIds: ['custom', 'climate_and_policy'],
  },
  {
  ...
  },
  {
    ...
    locationType: ['custom-area', 'wdpa', 'country', 'worldwide'],
    categoryIds: ['contextual_layers', 'custom'],
  },
  {
