    ...
    <DialogTrigger asChild>
      ...
      >
        <motion.button
          ...
          className={`${WIDGET_FAB_BUTTON_STYLE} flex min-w-[48px] cursor-pointer items-center gap-2 py-4 pr-5 pl-4`}
...
export default WidgetsDeckButton;
