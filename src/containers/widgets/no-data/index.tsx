...
const NoData = () => {
  return (
    <div className="m-auto ml-[3%] flex min-h-[334px] w-[94%] max-w-full break-inside-avoid flex-col items-center justify-center rounded-3xl bg-white pt-8 pr-5 pl-10 shadow-widget md:ml-0 md:w-[540px]">
