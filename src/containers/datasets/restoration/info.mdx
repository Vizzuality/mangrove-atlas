...
At the national level most scores range between x and y. Scores are driven by factors such as tidal regime and current land use, and lower scores indicate that there may be more challenges to achieving successful restoration.
