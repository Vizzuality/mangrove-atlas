...
export function useSource(): SourceProps {
  return {
    id: 'national-dashboard-TANZANIA-source',
    type: 'vector',
...
export function useLayers({ id, color }: { id: LayerProps['id']; color: string }): LayerProps[] {
  return [
    {
      id: `${id}-TANZANIA-layer`,
      source: 'national-dashboard-TANZANIA-source',
...
const MangrovesNationalDashboardLayer = ({ beforeId, id }: LayerProps) => {
  ...
  const color = settings?.['national_dashboard_source_MangroveExtent2020TanzaniaFinalQAv2'];
