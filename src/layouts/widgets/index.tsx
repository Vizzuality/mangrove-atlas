    ...
    <AnimatePresence initial={false}>
      {!isFullScreen && (
        <motion.div
          ...
          className="left-0 h-full w-screen py-14 scrollbar-hide md:absolute md:top-0 md:w-[560px] md:overflow-y-auto md:bg-transparent md:px-4 print:bg-transparent"
        >
          <LocationWidget />
          {children}
        </motion.div>
